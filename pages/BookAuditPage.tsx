            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {/* Input 1: Industry */}
                  <div>
                    <label htmlFor="book-audit-calc-ind" className="block text-xs font-mono text-slate-300 mb-1">Industry</label>
                    <select
                      id="book-audit-calc-ind"
                      value={calcIndustry}
                      onChange={(e) => {
                  ...
                  {/* Input 2: Call Volume */}
                  <div>
                    <label htmlFor="book-audit-calc-calls" className="block text-xs font-mono text-slate-300 mb-1">
                      Monthly Calls: <span className="text-[#00d4ff] font-bold">{calcMonthlyCalls}</span>
                    </label>
                    <input
                      id="book-audit-calc-calls"
                      type="number"
                      min={10}
                      max={10000}
                      step={25}
                  ...
                  {/* Input 3: Avg Value */}
                  <div>
                    <label htmlFor="book-audit-calc-val" className="block text-xs font-mono text-slate-300 mb-1">
                ...
                <form onSubmit={handleNextStep} className="space-y-6">
                  ...
                  {formStep === 1 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {/* Full Name */}
                        <div>
                          <label htmlFor="book-audit-name-input" className="block text-xs font-mono text-slate-300 mb-1">Full Name *</label>
                          <input
                            id="book-audit-name-input"
                            type="text"
                            required
                        ...
                        {/* Business Name */}
                        <div>
                          <label htmlFor="book-audit-company-input" className="block text-xs font-mono text-slate-300 mb-1">Business Name *</label>
                          <input
                            id="book-audit-company-input"
                            type="text"
                            required
                        ...
                        {/* Work Email */}
                        <div>
                          <label htmlFor="book-audit-email-input" className="block text-xs font-mono text-slate-300 mb-1">Work Email *</label>
                          <input
                            id="book-audit-email-input"
                            type="email"
                            required
                        ...
                        {/* Phone Number */}
                        <div>
                          <label htmlFor="book-audit-phone-input" className="block text-xs font-mono text-slate-300 mb-1">
                            Phone Number (for SMS & WhatsApp confirmation) *
                          </label>
                          <input
                            id="book-audit-phone-input"
                            type="tel"
                            required
                  ...
                  {formStep === 2 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        {/* Industry Dropdown */}
                        <div>
                          <label htmlFor="book-audit-step2-industry" className="block text-xs font-mono text-slate-300 mb-1">Industry *</label>
                          <select
                            id="book-audit-step2-industry"
                        ...
                        <div>
                          <label htmlFor="book-audit-step2-calls" className="block text-xs font-mono text-slate-300 mb-1">Monthly Call Volume *</label>
                          <input
                            id="book-audit-step2-calls"
                            type="text"
                            required
                            placeholder="e.g. 300"
                  ...
                  {formStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="book-audit-step3-date" className="block text-xs font-mono text-slate-300 mb-1">Preferred Date *</label>
                          <input
                            id="book-audit-step3-date"
                            type="date"
                            required
                        ...
                        <div>
                          <label htmlFor="book-audit-step3-time" className="block text-xs font-mono text-slate-300 mb-1">Preferred Time *</label>
                          <select
                            id="book-audit-step3-time"
