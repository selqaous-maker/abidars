...
export const AuditBookingModal: React.FC<AuditBookingModalProps> = ({
  ...
  const getHeadline = () => {
    const src = (typeof source === 'string' ? source : String(source || '')).toLowerCase();
          ...
          <div className="lg:w-2/5 bg-[#050507] p-6 border-b lg:border-b-0 lg:border-r border-white/10 space-y-6 shrink-0">
            ...
            <div className="space-y-2 pt-2 border-t border-white/10">
              ...
              <div className="space-y-1 text-[11px] font-mono text-slate-400">
                ...
                <div className="flex items-center gap-2"><span className="text-slate-400 font-bold">2.</span> Workflow Architecture</div>
                <div className="flex items-center gap-2"><span className="text-slate-400 font-bold">3.</span> Deployment Blueprint</div>
                <div className="flex items-center gap-2"><span className="text-slate-400 font-bold">4.</span> Proposal & SLA Setup</div>
                <div className="flex items-center gap-2"><span className="text-slate-400 font-bold">5.</span> Go Live (~14 Days)</div>
              </div>
            </div>
              ...
              <div className="py-4 space-y-6 animate-in fade-in duration-200">
                ...
                <div className="bg-[#050507] border border-white/10 p-4 sm:p-5 rounded-sm text-xs font-mono space-y-2 max-w-md mx-auto text-left">
                  <div className="text-[#00d4ff] font-bold uppercase tracking-wider border-b border-white/10 pb-2 mb-2 flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-slate-400 font-normal">PEXEK AI Audit</span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-1">
                    ...
                    <span className="col-span-2 text-[#00d4ff] font-bold">{formData.biggestChallenge}</span>
                  </div>
