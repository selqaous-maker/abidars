...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navSections: NavSection[] = [
    {
      title: 'Solutions',
      directPath: '/ai-receptionist',
      items: [
        { label: 'AI Receptionists', path: '/ai-receptionist' },
        { label: 'Lead Qualification AI', path: '/lead-qualification-ai' },
        { label: 'Appointment Booking AI', path: '/appointment-booking-ai' },
        { label: 'Workflow Automation', path: '/workflow-automation' },
        { label: 'Conversation Intelligence', path: '/conversation-intelligence' },
      ],
    },
    {
      title: 'Industries',
      directPath: '/industry-playbooks',
      items: [
        { label: 'Dental Practices', path: '/dental-ai-receptionist' },
        { label: 'Healthcare & Medical', path: '/healthcare-ai-receptionist' },
        { label: 'Business Services', path: '/business-services-ai' },
        { label: 'Real Estate', path: '/real-estate-ai-receptionist' },
        { label: 'Legal Intake', path: '/legal-ai-receptionist' },
        { label: 'E-commerce', path: '/ecommerce-ai-receptionist' },
      ],
    },
    {
      title: 'Deployment',
      directPath: '/deployment',
      items: [
        { label: 'Managed Deployment', path: '/deployment' },
        { label: 'Deployment Blueprints', path: '/deployment-blueprints' },
    ...
    },
    {
      ...
      directPath: '/blog',
      items: [
        { label: 'AI Voice Insights', path: '/blog' },
        { label: 'Industry Playbooks', path: '/industry-playbooks' },
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#050507]/95 backdrop-blur-md border-b border-white/10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        >
          <img 
            src="https://i.ibb.co/qLm5B98M/Chat-GPT-Image-Jul-8-2026-05-29-33-PM-removebg-preview-1.png" 
            alt="PEXEK" 
              ...
              >
                <button
                  ...
                  className={`px-3 py-2 text-xs uppercase tracking-wider font-mono font-bold rounded-[2px] flex items-center gap-1.5 transition-all ${
                    isSectionActive || activeDropdown === section.title
                ...
                >
                  ...
                  <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${
                    activeDropdown === section.title ? 'rotate-180 text-[#00d4ff]' : 'text-slate-400'
                  }`} />
                </button>

                {/* DROPDOWN MENU */}
                {activeDropdown === section.title && section.items && (
                  <div className="absolute top-full left-0 w-64 pt-2 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                    <div className="bg-[#0a0e1a] border border-white/15 rounded-[2px] p-2 shadow-2xl space-y-1">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#0a0e1a] border-b border-white/15 px-4 py-6 space-y-6 animate-in slide-in-from-top-2 duration-200">
